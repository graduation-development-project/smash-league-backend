...
import { ReportStatus, UserReport } from '@prisma/client';
...
export class CreateReportUseCase {
	...
	async execute(request: IRequestUser, createReport: CreateReport): Promise<ApiResponse<any>> {
		const tournament = await this.tournamentRepository.getTournament(createReport.tournamentId);
